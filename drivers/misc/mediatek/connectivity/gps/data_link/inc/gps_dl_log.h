...
#if GPS_DL_ON_LINUX
#define __GDL_LOGE(mod, fmt, ...) pr_debug("GDL[E:%d] [%s:%d]: "fmt, \
	mod, __func__, __LINE__, ##__VA_ARGS__)
#define __GDL_LOGW(mod, fmt, ...) pr_debug("GDL[W:%d] [%s:%d]: "fmt, \
	mod, __func__, __LINE__, ##__VA_ARGS__)
...
#define __GDL_LOGXE(mod, link_id, fmt, ...) pr_debug("GDL-%d[E:%d] [%s:%d]: "fmt, \
	link_id, mod, __func__, __LINE__, ##__VA_ARGS__)

#define __GDL_LOGXW(mod, link_id, fmt, ...) pr_debug("GDL-%d[W:%d] [%s:%d]: "fmt, \
	link_id, mod, __func__, __LINE__, ##__VA_ARGS__)
